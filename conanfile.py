...
class SkyboltConan(ConanFile):
    ...
    def configure(self):
        self.options["openscenegraph"].with_curl = True # Required for loading terrain tiles from http sources
    ...
    def build(self):
        ...
        cmake.definitions["OSG_STATIC_LIBS"] = str(not self.options["openscenegraph"].shared)
    ...
    def package_info(self):
        ...
        self.cpp_info.libs = ["SkyboltVis", "SkyboltSim", "SkyboltCommon", "SkyboltEngine", "AircraftHud"]
